...
from .views import QuizHistoryView, QuizQuestionCreateView, QuizQuestionListView, RegisterView, LoginView, UserProfileUpdate, UserView, LogoutView,UserProfileView,QuestionHistoryDetailView, PhotoView
